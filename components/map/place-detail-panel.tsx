    ...
    <AnimatePresence>
      {place && (
        <motion.div
          ...
          className="fixed right-0 top-0 z-30 h-full w-full md:w-96"
        ...
        >
          ...
          >
            ...
            {/* Content */}
            <div className="overflow-y-auto p-5 pt-4 md:p-6 md:pt-5" style={{ maxHeight: "calc(100vh - 4px)" }}>
              {/* Category badge */}
              <motion.div
              ...
              {/* Place name */}
              <motion.h2
                className="mt-3 font-display text-xl font-bold uppercase tracking-wide text-white md:text-2xl"
              ...
              {/* Description */}
              <motion.p
                className="mt-3 font-body text-sm leading-relaxed text-white/80 md:text-base"
